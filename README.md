...
```text
pnpm dlx agent-interop-runtime@0.3.2 doctor
pnpm dlx agent-interop-runtime@0.3.2 serve
```
...
```text
pnpm dlx agent-interop-runtime@0.3.2 install
pnpm dlx agent-interop-runtime@0.3.2 install --write
```
